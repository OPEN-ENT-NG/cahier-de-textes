...
public class SessionServiceImpl implements SessionService {
     ...
     * @param handler
     */
    private void getSessions(String startDate, String endDate, String ownerId, List<String> listAudienceId, List<String> listSubjectId, List<String> listTeacherId,
