package fr.openent.diary.security.filters;
...
public class HomeworkAccessFilter implements ResourcesProvider {
    ...
    public void authorize(final HttpServerRequest request, final Binding binding, final UserInfos user, final Handler<Boolean> handler) {
        final SqlConf conf = SqlConfs.getConf(HomeworkController.class.getName());
                ...
                diaryService.listGroupsFromChild(user.getChildrenIds(), new Handler<Either<String, JsonArray>>() {
                    ...
                    public void handle(Either<String, JsonArray> event) {
                        if (event.isRight()) {
                            ...
                            showAccess(request, binding, user, handler, conf, resourceId, groupsAndUserIds);
                        } else {
    ...
    private void showAccess(final HttpServerRequest request, Binding binding, UserInfos user, final Handler<Boolean> handler, SqlConf conf, String resourceId, List<String> groupsAndUserIds) {
        request.pause();
