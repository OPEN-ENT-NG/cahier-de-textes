...
/***/ (function(module, exports, __webpack_require__) {
	...
	var directives = __webpack_require__(113);
	    ...
	    function ($scope, $rootScope, model, route, $location, $window, $sce) {
	        ...
	        route({
	            ...
	            createLessonView: function (params) {
	                $scope.createLesson = new _1.Lesson();
	                $scope.lessonDescriptionIsReadOnly = false;
	                $scope.homeworkDescriptionIsReadOnly = false;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Lesson = (function () {
	    function Lesson(data) {
	        this.color = tools.DEFAULT_ITEM_COLOR;
	        this.state = tools.DEFAULT_STATE;
	        this.api = { delete: '/diary/lesson/:id' };
	        this.selected = false;
	        //this.collection(Attachment);
	        // initialize homeworks collection (see lib.js)
	        if (!this.homeworks) {
	            this.homeworks = new _1.Homeworks();
	        }
	        this.subject = (data) ? data.subject : new _1.Subject();
	     ...
	     * @param attachment
	     */
	    Lesson.prototype.addAttachment = function (attachment) {
	        this.attachments.push(attachment);
	    };
	    ;
	    /**
	     ...
	     */
	    Lesson.prototype.deleteModelReferences = function () {
	        var that = this;
	    ...
	    Lesson.prototype.save = function (cb, cbe) {
	        ...
	        return subjectPromise.then(function () {
	            ...
	            return lessonPromise.then(function () {
	                return that.saveHomeworks(cb, cbe).then(function () {
	    ...
	    Lesson.prototype.create = function (cb, cbe) {
	        ...
	        return createSubjectPromise.then(function () {
	            return entcore_1.model.getHttp()({
	                ...
	                entcore_toolkit_1.Mix.extend(_this, result.data);
	    ...
	    Lesson.prototype.load = function (loadHomeworks, cb, cbe) {
	        ...
	        return entcore_1.model.getHttp()({
	            ...
	            entcore_toolkit_1.Mix.extend(_this, entcore_1.model.LessonService.mapLesson(result.data));
	            if (loadHomeworks) {
	    ...
	    Lesson.prototype.toJSON = function () {
	        var json = {
	            ...
	            lesson_date: entcore_1.moment(this.date).format(tools.DATE_FORMAT),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.EditLessonController = entcore_1.ng.controller('EditLessonController', ['$scope', '$rootScope', '$routeParams', function ($scope, $rootScope, $routeParams) {
	        ...
	        function populateExistingLesson() {
	            ...
	            $scope.newItem = {
	                date: entcore_1.moment($scope.lesson.date),
	                beginning: $scope.lesson.startMoment,
	            ...
	            $scope.loadHomeworksForCurrentLesson(function () {
	                $scope.lesson.homeworks.forEach(function (homework) {
	                    ...
	                    entcore_1.model.loadHomeworksLoad(homework, entcore_1.moment(homework.date).format("YYYY-MM-DD"), $scope.lesson.audience.id);
	                });
	            });
	        }
	        /*
	        ...
	        */
	        ...
	        $scope.loadHomeworksForCurrentLesson = function (cb) {
	            ...
	            if (needSqlSync) {
	                entcore_1.model.loadHomeworksForLesson($scope.lesson, function () {
	        ...
	        var createOrUpdateLesson = function (goMainView, cb) {
	            ...
	            return $scope.lesson.save(function () {
	                ...
	                $scope.lesson.audience = entcore_1.model.audiences.findWhere({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var entcore_1 = __webpack_require__(1);
	var visa_service_1 = __webpack_require__(101);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var entcore_1 = __webpack_require__(1);
	var history_service_1 = __webpack_require__(107);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var index_1 = __webpack_require__(3);
	var pedagogic_item_service_1 = __webpack_require__(96);
	exports.QuickSearchController = entcore_1.ng.controller('QuickSearchController', ['$scope', '$rootScope', function ($scope, $rootScope) {
	        var vm = _this;
	        var id = Date.now();
	        /**
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var entcore_1 = __webpack_require__(1);
	exports.SearchDropDownController = entcore_1.ng.controller('SearchDropDownController', ['$scope', '$sce', '$timeout', function ($scope, $sce, $timeout) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var entcore_1 = __webpack_require__(1);
	exports.RightPanelController = entcore_1.ng.controller('RightPanelController', ['$scope', '$rootScope', function ($scope, $rootScope) {
	        $rootScope.currentRightPanelVisible = undefined;
	        var id = Date.now();
	        var vm = _this;
	        $scope.panelVisible = false;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var audiences_service_1 = __webpack_require__(87);
	var subject_service_1 = __webpack_require__(82);
	exports.DiaryCalendarController = entcore_1.ng.controller('DiaryCalendarController', ['$scope', '$rootScope', '$timeout', '$window', '$element', function ($scope, $rootScope, $timeout, $window, $element) {
	        ...
	        $scope.$watch("mondayOfWeek", function (n, o) {
	            ...
	            var date = entcore_1.moment();
	            // create calendar objet
	            vm.calendar = new entcore_1.calendar.Calendar({
	                week: entcore_1.moment($scope.mondayOfWeek).week(),
	                year: entcore_1.moment($scope.mondayOfWeek).year()
	            });
	            /*
	            * //TODO no a good practice but all the code refer to model.calendar
	            * try to dissociate
	            */
	            entcore_1.model.calendar = vm.calendar;
	            vm.calendar.week = $scope.mondayOfWeek.week();
	            vm.calendar.setDate($scope.mondayOfWeek);
	            $scope.lastDay = entcore_1.moment($scope.mondayOfWeek).add(6, 'd');
	        });
	        /*
	        ...
	        */
	        function bindEvents() {
	            ...
	            entcore_1.angular.element($window).bind('resize', entcore_1._.throttle(function () {
	        ...
	        vm.refreshCalendar = function () {
	            ...
	            var scheduleItems = entcore_1._.where(entcore_1._.map($scope.items, function (item) {
	        ...
	        vm.removeCollisions = function (day) {
	            entcore_1._.each(day.scheduleItems, function (scheduleItem) {
	        ...
	        vm.calcAllCollisions = function (item, day) {
	            ...
	            while (collision) {
	                ...
	                day.scheduleItems.forEach(function (scheduleItem) {
	                    if (scheduleItem != item && (vm.between(item.beginning, scheduleItem.beginning, scheduleItem.end) ||
	        ...
	        */
	        function disposeItems() {
	            ...
	            entcore_1._.each(vm.calendar.days.all, function (day) {
	                vm.removeCollisions(day);
	                entcore_1._.each(day.scheduleItems.all, function (item) {
	        ...
	        function getWidth(scheduleItem, day) {
	            var concurrentItems = entcore_1._.filter(day.scheduleItems.all, function (item) {
	                return item.beginning.unix() <= scheduleItem.end.unix() && item.end.unix() >= scheduleItem.beginning.unix();
	            });
	            var maxGutter = 0;
	            entcore_1._.forEach(concurrentItems, function (item) {
	        ...
	        */
	        function disposeItem(item, day) {
	            ...
	            var beginningMinutesHeight = item.beginning.minutes() * entcore_1.calendar.dayHeight / 60;
	            var endMinutesHeight = item.end.minutes() * entcore_1.calendar.dayHeight / 60;
	            var hours = entcore_1.calendar.getHours(item, day);
	            var top = (hours.startTime - entcore_1.calendar.startOfDay) * entcore_1.calendar.dayHeight + beginningMinutesHeight;
	            var containerTop = "0px";
	            var containerHeight = "100%";
	            var scheduleItemHeight = ((hours.endTime - hours.startTime) * entcore_1.calendar.dayHeight - beginningMinutesHeight + endMinutesHeight);
	            if (top < 0) {
	        ...
	        vm.createItem = function (day, timeslot) {
	            ...
	            $scope.newItem.beginning = entcore_1.moment().utc().year(year).dayOfYear(day.index).hour(timeslot.start).minute(0).second(0);
	            $scope.newItem.end = entcore_1.moment($scope.newItem.beginning).add(1, 'h');
	        ...
	        vm.updateCalendarWeek = function () {
	            ...
	            if (entcore_1.moment(vm.calendar.dayForWeek).week() === 1 && entcore_1.moment(vm.calendar.dayForWeek).dayOfYear() > 7) {
	                vm.calendar = new entcore_1.calendar.Calendar({
	                    week: entcore_1.moment(vm.calendar.dayForWeek).week(),
	                    year: entcore_1.moment(vm.calendar.dayForWeek).year() + 1
	                });
	            }
	            else if (entcore_1.moment(vm.calendar.dayForWeek).week() === 53 && entcore_1.moment(vm.calendar.dayForWeek).dayOfYear() < 7) {
	                vm.calendar = new entcore_1.calendar.Calendar({
	                    week: entcore_1.moment(vm.calendar.dayForWeek).week(),
	                    year: entcore_1.moment(vm.calendar.dayForWeek).year() - 1
	                });
	                ...
	                vm.calendar = new entcore_1.calendar.Calendar({
	                    week: entcore_1.moment(vm.calendar.dayForWeek).week(),
	                    year: entcore_1.moment(vm.calendar.dayForWeek).year()
	                });
	            }
	            entcore_1.model.trigger('calendar.date-change');
	            vm.refreshCalendar();
	        };
	        $scope.previousTimeslots = function () {
	            entcore_1.calendar.startOfDay--;
	            entcore_1.calendar.endOfDay--;
	            vm.calendar = new entcore_1.calendar.Calendar({
	                week: entcore_1.moment(vm.calendar.dayForWeek).week(),
	                year: entcore_1.moment(vm.calendar.dayForWeek).year()
	            });
	        ...
	        $scope.onCreateClose = function () {
	            if (entcore_1.attributes) {
	                $scope.$eval(entcore_1.attributes.onCreateClose);
	            }
	        };
	        ...
	        $scope.createNewtemFromSchedule = function (item) {
	            ...
	            var year = vm.calendar.year;
	            //set beginning
	            $scope.newItem.beginning = entcore_1.moment(item.startMoment);
	            $scope.newItem.end = entcore_1.moment(item.endMoment);
	            audiences_service_1.AudienceService.getAudiencesAsMap(entcore_1.model.me.structures).then(function (audienceMap) {
	                ...
	                if (item.data && item.data.subject) {
	                    ...
	                    if (item.data.subject.subjectId) {
	                        $scope.newItem.subject = entcore_1._.find(entcore_1.model.subjects.all, function (subject) {
	                            return subject.originalsubjectid === item.data.subject.subjectId;
	                        });
	                        if (!$scope.newItem.subject) {
	                            item.data.subject.teacher_id = entcore_1.model.me.userId;
	                            $scope.newItem.subject = subject_service_1.SubjectService.mapToDiarySubject(item.data.subject);
	                        }
	                    }
	                    else {
	                        //data from modelweek
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var secure_service_1 = __webpack_require__(86);
	var tools_1 = __webpack_require__(73);
	exports.diaryMultiCalendarFilterController = entcore_1.ng.controller('diaryMultiCalendarFilterController', ['$scope', function ($scope) {
	        var promiseFilter;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var entcore_1 = __webpack_require__(1);
	exports.timePicker = entcore_1.ng.directive('timePicker', function () {
	    return {
	        scope: {
	            ngModel: '=',
	            ngChange: '&'
	        ...
	        link: function (scope, element, attributes) {
	            var hideFunction = function (e) {
	                ...
	                if (!timepicker || element[0] === e.target || entcore_1.$('.bootstrap-timepicker-widget').find(e.target).length !== 0) {
	                    return;
	                }
	                timepicker.hideWidget();
	            };
	            entcore_1.$('body, lightbox').on('click', hideFunction);
	            entcore_1.$('body, lightbox').on('focusin', hideFunction);
	            if (!entcore_1.$.fn.timepicker) {
	                entcore_1.$.fn.timepicker = function () {
	                };
	                entcore_1.http().loadScript('/infra/public/js/bootstrap-timepicker.js').then(function () {
