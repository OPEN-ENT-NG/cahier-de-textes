	...
	entcore_1.Behaviours.register('diary', {
	    ...
	    resource: function (resource) {
	        ...
	        for (var behaviour in diariesBehaviours.resources) {
	            if (entcore_1.model.me.hasRight(rightsContainer, diariesBehaviours.resources[behaviour]) || entcore_1.model.me.userId === resource.owner.userId || entcore_1.model.me.userId === rightsContainer.owner.userId) {
	    ...
	    workflow: function () {
	        ...
	        for (var prop in diariesWorkflow) {
	            if (entcore_1.model.me.hasWorkflow(diariesWorkflow[prop])) {
	                workflow[prop] = true;
	            }
	        }
	        return workflow;
