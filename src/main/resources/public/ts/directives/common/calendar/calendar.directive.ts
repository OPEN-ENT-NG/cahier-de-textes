import {angular, ng, model, _, moment, calendar, attributes} from 'entcore';
import {AudienceService} from "../../../services/audiences.service";
import {SubjectService} from "../../../services/subject.service";

export const diaryCalendar = ng.directive('diaryCalendar', function () {

		    return {
		        restrict: 'E',
						templateUrl: '/diary/public/template/directives/common/calendar/calendar.template.html',
						scope : {
							items : '=',
							mondayOfWeek : '=',
							itemTemplate : '@',
		        ...
		        controller: function ($scope, $rootScope, $timeout, $window, $element, $location) {
