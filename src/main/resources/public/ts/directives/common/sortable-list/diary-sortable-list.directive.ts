...
export const diarySortableList = ng.directive('diarySortableList', function () {
    return {
        restrict: 'A',
        controller: function () {
        },
...
export const diarySortableElement = ng.directive('diarySortableElement', function ($parse, $timeout) {
    return {
        scope: {
            ngModel: '=',
            ngChange: '&'
