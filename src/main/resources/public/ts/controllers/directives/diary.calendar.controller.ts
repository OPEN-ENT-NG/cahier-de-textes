...
export const DiaryCalendarController = ng.controller('DiaryCalendarController',
    ['$scope', '$rootScope', '$timeout', '$window', '$element', ($scope, $rootScope, $timeout, $window, $element) => {
