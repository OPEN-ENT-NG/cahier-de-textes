import {angular, ng, _, model, notify, moment, idiom as lang} from 'entcore';
import {Homework, PedagogicDay, SearchForm} from "../../models/index";
import {PedagogicItemService} from "../../services/pedagogic-item.service";

export const QuickSearchController = ng.controller('QuickSearchController',
